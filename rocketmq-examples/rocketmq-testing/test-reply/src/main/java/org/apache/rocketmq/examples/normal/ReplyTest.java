...
public class ReplyTest implements CommandLineRunner {
    private final Logger log = LoggerFactory.getLogger(ReplyTest.class);
    ...
    public static void main(String[] args)  {
        SpringApplication.run(ReplyTest.class, args);
    }
    ...
    public void run(String... args) throws InterruptedException {
        ...
        CompletableFuture.runAsync(() -> {
            for (int i = 0; i < COUNT; i++) {
                Msg msg = rocketMQTemplate.sendAndReceive(topic + ":" + TAG, new Msg(ID, i), Msg.class);
                log.debug("index: {}, {}", i, msg);
                ReplyChecker.getInstance().record(msg);
            }
        });
    ...
    public static final String TAG = "proxy-rocketmq-reply-test";
    ...
    static {
        ...
        CHECKERS.add(ReplyChecker.getInstance());
    }
}
