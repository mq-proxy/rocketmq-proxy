...
public class ConsumerConstants {
    ...
    public static final String CONSUMER_GROUP =
            EnvTool.envWithDefault("rocketmq.consumer-group","ROCKETMQ_CONSUMER_GROUP", "proxy_test_consumer_group");
    public static final String SUBSCRIPTION =
            EnvTool.envWithDefault("rocketmq.subscription","ROCKETMQ_SUBSCRIPTION", "*");
}
