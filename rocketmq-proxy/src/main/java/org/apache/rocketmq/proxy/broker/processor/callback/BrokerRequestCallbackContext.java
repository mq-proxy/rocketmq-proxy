 ...
 */
package org.apache.rocketmq.proxy.broker.processor.callback;

import org.apache.rocketmq.remoting.protocol.RemotingCommand;

public class BrokerRequestCallbackContext {
    private String brokerAddr;
    private RemotingCommand request;
    private RemotingCommand response;

    public BrokerRequestCallbackContext(String brokerAddr, RemotingCommand request, RemotingCommand response) {
