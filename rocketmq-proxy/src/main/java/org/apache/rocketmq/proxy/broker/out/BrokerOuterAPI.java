 ...
 */
package org.apache.rocketmq.proxy.broker.out;
...
public class BrokerOuterAPI {
    ...
    private RegisterBrokerResult registerBroker(
        ...
        RemotingCommand request = RemotingCommand.createRequestCommand(ProxyRequestCode.REGISTER_PROXY, requestHeader);
    ...
    public void unregisterBroker(
        ...
        requestHeader.setBrokerName(brokerName);
        requestHeader.setClusterName(clusterName);
        RemotingCommand request = RemotingCommand.createRequestCommand(ProxyRequestCode.UNREGISTER_PROXY, requestHeader);
