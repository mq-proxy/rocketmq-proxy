...
public class ConsumerGroupInfo {
    ...
    private volatile List<String> clientIds = new ArrayList<>(0);
    private volatile ConcurrentMap<String, String> clientIdMap = new ConcurrentHashMap<>(16);
...
//        clientIdFromRealClient.remove(clientChannelInfo.getClientId());
        if (old != null) {
    ...
    public ClientChannelInfo doChannelCloseEvent(final String remoteAddr, final Channel channel) {
        ...
        return this.channelInfoTable.remove(channel);
    }
